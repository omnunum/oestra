...
class Portfolio:
    ...
    def split_lifecycle(self, l: Lifecycle, units: int) -> Tuple[Lifecycle, Lifecycle]:
    ...
    def get_tax_info(self, year: int, region: str, status: str, capital_gains=False) -> Tuple[int, list]:
    ...
    def calculate_income_taxes(self, year: int, gains: Optional[float] = None) -> dict:
        ...
        state_deduction = f.get("state_deduction") or standard_state_deduction
